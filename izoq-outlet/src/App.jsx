...
const styles = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  @media (max-width: 768px) {
    ...
    .wallet-actions { flex-wrap: wrap; gap: 10px; }
    .wallet-action-btn { flex: 1; min-width: 80px; font-size: 11px; }

    /* Token list */
    .token-row { padding: 12px 16px; }
    .token-name { font-size: 13px; }
    .token-balance { font-size: 12px; }
    ...
    /* Chain selector */
    .chain-tabs { flex-wrap: wrap; gap: 6px; }
    .chain-tab { font-size: 11px; padding: 6px 10px; }

    /* Verification steps */
    .kyc-steps { flex-direction: column; gap: 12px; }
    .kyc-step-connector { display: none; }
    .kyc-step { flex-direction: row; text-align: left; gap: 14px; }

    /* Seed phrase grid */
    .seed-grid { grid-template-columns: 1fr 1fr !important; }
    .seed-word { font-size: 11px; padding: 8px; }

    /* Import tabs */
    .import-tabs { flex-direction: column; }
    .import-tab { text-align: center; }
...
function Wallet() {
  ...
  const CHAINS_USER = [
    ...
    { name: "Ethereum", icon: "⟠", color: "#627eea", prefix: "0x" },
    { name: "BNB Chain", icon: "🟡", color: "#f3ba2f", prefix: "0x" },
    { name: "Solana", icon: "◎", color: "#9945ff", prefix: "" },
    { name: "TRON (TRC-20)", icon: "◈", color: "#ef0027", prefix: "T" },
    { name: "Ripple XRP", icon: "💧", color: "#00aae4", prefix: "r" },
    { name: "Cardano", icon: "💙", color: "#0033ad", prefix: "addr1" },
    { name: "Polygon", icon: "🟣", color: "#8247e5", prefix: "0x" },
    { name: "Avalanche", icon: "🔺", color: "#e84142", prefix: "0x" },
    { name: "Litecoin", icon: "Ł", color: "#bfbbbb", prefix: "L" },
    { name: "Dogecoin", icon: "🐕", color: "#c2a633", prefix: "D" },
    { name: "Polkadot", icon: "⚫", color: "#e6007a", prefix: "1" },
    { name: "Stellar XLM", icon: "✦", color: "#7d00ff", prefix: "G" },
    { name: "Cosmos ATOM", icon: "⚛", color: "#2e3148", prefix: "cosmos1" },
    { name: "Algorand", icon: "🌀", color: "#00b4d8", prefix: "" },
    { name: "Fantom", icon: "👻", color: "#1969ff", prefix: "0x" },
    { name: "Tezos", icon: "🔵", color: "#2c7df7", prefix: "tz1" },
    { name: "Monero", icon: "🔒", color: "#ff6600", prefix: "4" },
    { name: "Zcash", icon: "🛡", color: "#f4b728", prefix: "t1" },
    { name: "Dash", icon: "🔷", color: "#008de4", prefix: "X" },
    { name: "EOS", icon: "⚡", color: "#000000", prefix: "" },
    { name: "Base", icon: "🔵", color: "#0052ff", prefix: "0x" },
    { name: "Arbitrum", icon: "🔷", color: "#28a0f0", prefix: "0x" },
    { name: "Optimism", icon: "🔴", color: "#ff0420", prefix: "0x" },
    { name: "Cronos", icon: "🔶", color: "#002d74", prefix: "0x" },
    { name: "NEAR", icon: "🌐", color: "#00c08b", prefix: "" },
    { name: "Hedera HBAR", icon: "📡", color: "#222222", prefix: "0.0." },
    { name: "Filecoin", icon: "🗄", color: "#0090ff", prefix: "f1" },
    { name: "TON", icon: "💎", color: "#0088cc", prefix: "" },
];
...
export default function IZOQOutlet() {
